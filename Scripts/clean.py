...
from constants import PROJECT_DIR, CODE_DIR, TEST_DIR, VENDOR_DIR, SAD_CS_FRAMEWORK_DIR
...
def rm_vs_files():
    ...
    # sad/Code/SadCSFramework/*.vcxproj
    # sad/Code/SadCSFramework/*.vcxproj.filters
    # sad/Code/SadCSFramework/*.vcxproj.user
    # sad/Code/SadCSFramework/*.csproj
    rdfe(SAD_CS_FRAMEWORK_DIR, proj_ext)
    rdfe(SAD_CS_FRAMEWORK_DIR, proj_filters_ext)
    rdfe(SAD_CS_FRAMEWORK_DIR, proj_user_ext)
    rdfe(SAD_CS_FRAMEWORK_DIR, csproj_ext)
...
def rm_makefiles():
    ...
    # sad/Code/SadCSFramework/Makefile
    # sad/Code/SadCSFramework/*.make
    sad_cs_framework_makefile = os.path.join(SAD_CS_FRAMEWORK_DIR, makefile)
    rdf(sad_cs_framework_makefile)
    rdfe(SAD_CS_FRAMEWORK_DIR, makefile_ext)
...
def rm_xcode_files():
    ...
    # sad/Code/SadCSFramework/*.xcodeproj
    rdfe(SAD_CS_FRAMEWORK_DIR, xcodeproj_ext)
